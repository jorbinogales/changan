...
import Icono from './../../public/icono-menu-mobile.svg';
import './navbar.css';
		...
		<nav className="p-4 font-play text-primary">
			<div className="max-w-[1300px] w-full mx-auto flex justify-between items-center">
				...
				<span className="block lg:hidden">
                    <img src={Icono} alt="Logo Mobile" className="h-10 w-auto" />
                </span>
				...
				<ul className="hidden lg:flex space-x-6">
					{[
						{ label: 'Inicio', href: 'https://changanvzla.com/' },
						{ label: 'Descubre Changan', href: 'https://changanvzla.com/changan-en-venezuela/' },
						{ label: 'Vehículos', href: 'https://changanvzla.com/repuestos-y-accesorios-para-vehiculos-changan-2/' },
						{ label: 'Concesionarios', href: 'https://changanvzla.com/concesionarios/' },
						{ label: 'Contacto', href: 'https://changanvzla.com/contacto/' },
					].map((item) => (
						<li key={item.label}>
						<a
							href={item.href}
							className="cursor-pointer text-primary-changan play-regular hover:underline"
							target="_blank"
